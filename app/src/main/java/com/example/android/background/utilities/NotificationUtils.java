...
public class NotificationUtils {
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            NotificationChannel notificationChannel = new NotificationChannel(
                    ...
                    context.getResources().getString(R.string.charging_reminder_notification_title),
    ...
    public static PendingIntent contentIntent(Context context){
        ...
        return PendingIntent.getActivity(context, PENDING_INTENT_ID, intentMainActivity, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public static Bitmap largeIcon(Context context){
        ...
        return BitmapFactory.decodeResource(resourcesObj, R.drawable.ic_local_drink_black_24px);
    }
